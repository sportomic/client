...
import { Link, useNavigate, useLocation } from "react-router-dom"; // Only import from react-router-dom
        ...
        >
          <li className="md:inline-block">
            <Link
              ...
              className={`block text-center font-Outfit text-2xl text-[#27262a] font-semibold py-2 px-4 ${
